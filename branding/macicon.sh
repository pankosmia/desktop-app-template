...
# 1. Create mac_icon_1024x1024.png and place it in the `source` subdirectory, one level down from `branding.
# 2. Run this script in a terminal by entering: `./icnsicons.sh` from the `branding` directory.
...
cp source/mac_icon_1024x1024.png building_blocks/for_icon_icns/icon_1024x1024.png
