...
| Description | Linux | Windows | MacOS |
|-------|-------|---------|-------|
| removes the build directory and runs `cargo clean` | /linux/scripts/clean.bsh | \windows\scripts\clean.bat<br />Optional arguments:<br />`.\clean.bat -s`<br />(Will not ask if the server is off.) | /macos/scripts/clean.zsh |
